...
- **Lei nº 9.504/1997 (Lei das Eleições), art. 57-B, inciso I**: a
  propaganda eleitoral na internet pode ser realizada em sítio do
  candidato, desde que o endereço eletrônico seja comunicado à Justiça
  Eleitoral.
...
- A análise de hospedagem foi feita em um único momento no tempo, um
  site pode trocar de hospedagem ou ser retirado do ar depois da
  coleta.
- O projeto não verifica o conteúdo político/eleitoral dos sites, apenas
  aspectos técnicos de hospedagem.
...
etapa. Ver [`README.md`](../README.md) para instruções de execução.
